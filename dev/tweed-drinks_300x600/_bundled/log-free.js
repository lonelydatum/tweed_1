...
function start() {
	...
	tl_cup.to('.cup_line', 2.8, { y: 0, opacity: 1 });
	...
	_commonJsCommonJs.tl.add('leave', "+=.2");
	_commonJsCommonJs.tl.to('.can', .65, { x: "+=3000" }, 'leave');
	_commonJsCommonJs.tl.to('.cup', .65, { x: "-=300" }, 'leave');
	_commonJsCommonJs.tl.from('.cup_can', .65, { x: "+=300" }, "leave+=.2");
}
