...
function start() {
	...
	_commonJsCommonJs.tl.from('.product', .3, { opacity: 0 });
	_commonJsCommonJs.tl.to('.product', .3, { opacity: 0 }, "+=3");

	_commonJsCommonJs.tl.set(".frame3", { opacity: 1 });
	_commonJsCommonJs.tl.from('.logo_text', .3, { opacity: 0 });
	_commonJsCommonJs.tl.from('.cta', .3, { opacity: 0 }, "+=.2");
}
